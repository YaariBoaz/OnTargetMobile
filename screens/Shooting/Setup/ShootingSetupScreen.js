                    ...
                    <View style={{flex:1}}>
                        ...
                        <View style={styles.infoContainer}>
                            ...
                            <Item regular style={{width: '20%'}}>
                                <Input onChangeText={(text) => this.setState({numberOfBullets: text})}
                                       value={this.state.numberOfBullets}
                        ...
                        <View style={styles.infoContainer}>
                            <View style={{
                                ...
                                <Image style={{width: 40, height: 40}} resizeMethod={"auto"}
                                       source={require('../../../assets/images/ic_illust_half_fullrange.png')}></Image>
                                <Text style={{width: '40%'}}>Range</Text>
                            </View>
                            <Item style={{width: '20%'}}>
                                <Input value={this.state.range} onChangeText={(text) => this.setState({range: text})} placeholder='50'/>
                            </Item>
                            <Picker
                                mode="dropdown"
                                ...
                                onValueChange={(itemValue) =>
                                    this.setState({rangeUnits: itemValue})
                                }
                            >
                                <Picker.Item label="Meter" value="Meters"/>
                ...
                <Button block style={{margin: 10, backgroundColor: '#3B3838'}}
                        onPress={() => navigate('ShootingsScreen', {
                            details: {
                                ...
                                rangeUnit: this.state.rangeUnits,
                                range: this.state.range,
                                numOfBullets: this.state.numberOfBullets,
                            }
